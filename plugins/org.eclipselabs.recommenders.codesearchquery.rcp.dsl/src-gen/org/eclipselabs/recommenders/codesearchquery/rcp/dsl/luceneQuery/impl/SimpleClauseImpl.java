...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Simple Clause</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class SimpleClauseImpl extends MinimalEObjectImpl.Container implements SimpleClause
{
   ...
   * @generated
   */
  public NotificationChain basicSetField(FieldName newField, NotificationChain msgs)
  {
    FieldName oldField = field;
    field = newField;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LuceneQueryPackage.SIMPLE_CLAUSE__FIELD, oldField, newField);
  ...
  public void setField(FieldName newField)
  {
    if (newField != field)
    {
      ...
      if (field != null)
        msgs = ((InternalEObject)field).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LuceneQueryPackage.SIMPLE_CLAUSE__FIELD, null, msgs);
      if (newField != null)
        msgs = ((InternalEObject)newField).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LuceneQueryPackage.SIMPLE_CLAUSE__FIELD, null, msgs);
      msgs = basicSetField(newField, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LuceneQueryPackage.SIMPLE_CLAUSE__FIELD, newField, newField));
  }
  ...
  public void setValue(String newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LuceneQueryPackage.SIMPLE_CLAUSE__VALUE, oldValue, value));
  }
