		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSimpleFieldAccess().getReturnVariableExpressionsAssignment_2(), "rule__SimpleField__ReturnVariableExpressionsAssignment_2");
					put(grammarAccess.getSimpleFieldAccess().getAllDeclaredMethodNamesAssignment_3(), "rule__SimpleField__AllDeclaredMethodNamesAssignment_3");
					put(grammarAccess.getSimpleFieldAccess().getDeclaredMethodNamesAssignment_4(), "rule__SimpleField__DeclaredMethodNamesAssignment_4");
					put(grammarAccess.getSimpleFieldAccess().getDeclaredFieldNamesAssignment_5(), "rule__SimpleField__DeclaredFieldNamesAssignment_5");
					put(grammarAccess.getSimpleFieldAccess().getAllDeclaredFieldNamesAssignment_6(), "rule__SimpleField__AllDeclaredFieldNamesAssignment_6");
					put(grammarAccess.getSimpleFieldAccess().getFullTextAssignment_7(), "rule__SimpleField__FullTextAssignment_7");
					put(grammarAccess.getSimpleFieldAccess().getFieldsReadAssignment_8(), "rule__SimpleField__FieldsReadAssignment_8");
					put(grammarAccess.getSimpleFieldAccess().getFieldsWrittenAssignment_9(), "rule__SimpleField__FieldsWrittenAssignment_9");
					put(grammarAccess.getSimpleFieldAccess().getUsedFieldsInFinallyAssignment_10(), "rule__SimpleField__UsedFieldsInFinallyAssignment_10");
					put(grammarAccess.getSimpleFieldAccess().getUsedFieldsInTryAssignment_11(), "rule__SimpleField__UsedFieldsInTryAssignment_11");
					...
					put(grammarAccess.getMethodFieldAccess().getDeclaredMethodsAssignment_4(), "rule__MethodField__DeclaredMethodsAssignment_4");
