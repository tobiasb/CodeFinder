		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getClauseExpressionAccess().getNAssignment_0_0(), "rule__ClauseExpression__NAssignment_0_0");
					put(grammarAccess.getClauseExpressionAccess().getMAssignment_0_1(), "rule__ClauseExpression__MAssignment_0_1");
					put(grammarAccess.getClauseExpressionAccess().getClauseAssignment_1_0(), "rule__ClauseExpression__ClauseAssignment_1_0");
					put(grammarAccess.getClauseExpressionAccess().getClauseAssignment_1_1(), "rule__ClauseExpression__ClauseAssignment_1_1");
					put(grammarAccess.getSimpleClauseAccess().getFieldAssignment_0(), "rule__SimpleClause__FieldAssignment_0");
					put(grammarAccess.getSimpleClauseAccess().getValueAssignment_2(), "rule__SimpleClause__ValueAssignment_2");
					put(grammarAccess.getTypeClauseAccess().getFieldAssignment_0(), "rule__TypeClause__FieldAssignment_0");
					put(grammarAccess.getTypeClauseAccess().getValueAssignment_2(), "rule__TypeClause__ValueAssignment_2");
