 ...
 * <ul>
 *   <li>{@link org.eclipselabs.recommenders.codesearchquery.rcp.dslQL1.qL1.impl.ModelImpl#getGreetings <em>Greetings</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  {
    return QL1Package.Literals.MODEL;
  }
  ...
  public EList<Greeting> getGreetings()
  {
    if (greetings == null)
    {
      greetings = new EObjectContainmentEList<Greeting>(Greeting.class, this, QL1Package.MODEL__GREETINGS);
    }
    return greetings;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case QL1Package.MODEL__GREETINGS:
