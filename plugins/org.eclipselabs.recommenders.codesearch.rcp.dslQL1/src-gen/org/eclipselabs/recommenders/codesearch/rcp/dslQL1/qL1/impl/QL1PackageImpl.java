...
public class QL1PackageImpl extends EPackageImpl implements QL1Package
{
   ...
   * @generated
   */
  private EClass modifierValueEClass = null;
   ...
   * @generated
   */
  public EReference getMethodPatternDefinition_Modifier()
  {
   ...
   * @generated
   */
  public EReference getModifier_Modifiers()
  {
   ...
   * @generated
   */
  public EClass getModifierValue()
  {
    return modifierValueEClass;
  }
   ...
   * @generated
   */
  public EAttribute getModifierValue_Value()
  {
    return (EAttribute)modifierValueEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(methodPatternDefinitionEClass, METHOD_PATTERN_DEFINITION__MODIFIER);
    ...
    createEReference(modifierEClass, MODIFIER__MODIFIERS);

    modifierValueEClass = createEClass(MODIFIER_VALUE);
    createEAttribute(modifierValueEClass, MODIFIER_VALUE__VALUE);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getMethodPatternDefinition_Modifier(), this.getModifier(), null, "modifier", null, 0, 1, MethodPatternDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getModifier_Modifiers(), this.getModifierValue(), null, "modifiers", null, 0, -1, Modifier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(modifierValueEClass, ModifierValue.class, "ModifierValue", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getModifierValue_Value(), ecorePackage.getEString(), "value", null, 0, 1, ModifierValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
