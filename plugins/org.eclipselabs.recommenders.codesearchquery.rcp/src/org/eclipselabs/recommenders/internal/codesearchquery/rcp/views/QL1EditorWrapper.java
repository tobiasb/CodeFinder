...
import org.eclipselabs.recommenders.codesearchquery.rcp.dslQL1.QL1StandaloneSetup;
import org.eclipselabs.recommenders.codesearchquery.rcp.dslQL1.ui.internal.QL1Activator;
...
public class QL1EditorWrapper extends AbstractEmbeddedEditorWrapper {
    ...
    void createQueryEditorInternal() {
        ...
        final Injector injector = activator
                .getInjector(QL1Activator.ORG_ECLIPSELABS_RECOMMENDERS_CODESEARCHQUERY_RCP_DSLQL1_QL1);
