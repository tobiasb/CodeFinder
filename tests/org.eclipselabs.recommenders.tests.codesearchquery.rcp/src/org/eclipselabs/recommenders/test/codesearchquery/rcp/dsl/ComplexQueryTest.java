...
public class ComplexQueryTest extends DslTestBase {
	...
	public void testMultipleFields01() throws Exception {
    	...
    	super.setUp();
		getParseResultAndExpect("Type:method AND Modifiers:private AND UsedTypes:org.eclipse.recommenders.codesearch.FeatureWeights", 0);
	}
	...
	public void testMultipleFields02() throws Exception {
    	...
    	super.setUp();
		getParseResultAndExpect("Type:method AND UsedTypes:org.eclipse.recommenders.codesearch.FeatureWeights AND Modifiers:private", 0);
	}
