...
public class TestMethodScenarios extends TestBase {
  ...
  public void testReturnTypeIndexer() {
      ...
      CodeIndexer _exercise = this.exercise(code, _returnTypeIndexer);
  ...
  public void testParameterTypesIndexer() {
      ...
      CodeIndexer _exercise = this.exercise(code, _parameterTypesIndexer);
      CodeIndexer index = _exercise;
  ...
  public void testParameterCountIndexer() {
      ...
      CodeIndexer _exercise = this.exercise(code, _parameterCountIndexer);
      CodeIndexer index = _exercise;
  ...
  public void testReturnVariableExpressionsIndexer() {
      ...
      CodeIndexer _exercise = this.exercise(code, _returnVariableExpressionIndexer);
      CodeIndexer index = _exercise;
